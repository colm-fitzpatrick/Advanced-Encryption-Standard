// Description: This is the UI that gives user options for generate random number, test a prime number, generate the next prime number and generate a set of prime number
